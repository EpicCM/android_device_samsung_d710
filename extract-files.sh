...
adb pull /system/lib/libsec-ril40.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/libsec-ril40.so
adb pull /system/lib/libsecril-client.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/libsecril-client.so
adb pull /system/bin/pppd_runner ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/pppd_runner
adb pull /system/etc/ppp/ip-up ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/ip-up
adb pull /system/etc/ppp/ip-down ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/ip-down
...
adb pull /system/etc/audio/Tx_ControlParams_BLUETOOTH_HEADSET.txt ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/Tx_ControlParams_BLUETOOTH_HEADSET.txt
adb pull /system/etc/audio/Rx_ControlParams_BLUETOOTH_HEADSET.txt ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/Rx_ControlParams_BLUETOOTH_HEADSET.txt
